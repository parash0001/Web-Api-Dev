	...
	const contactDetails = [
		{
			...
			stepName: "Phone",
			stepDescription: "(+977)-333-123-4567",
			stepUrl: "tel:+9773331234567",
		},
		{
			key: "email",
			stepNumber: <MdEmail />,
			stepName: "Email",
			stepDescription: "help@bloodbank.com",
			stepUrl: "mailto:help@bloodbank.com",
		},
		{
			key: "address",
			stepNumber: <FaMapMarkerAlt />,
			stepName: "Address",
			stepDescription: "Kathmandu, Bagmati, Nepal",
