          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div>
              <input
                ...
                className={`w-full text-center text-2xl font-bold border-2 rounded-xl px-4 py-3 focus:ring-0 focus:outline-none transition-colors ${
                  errors.otp
            ...
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-lg font-bold ${timeLeft > 60 ? 'text-gray-900' : 'text-red-600'}`}>{formatTime(timeLeft)}</p>
                </div>
                <div>
                  {canResend ? (
                    <button
